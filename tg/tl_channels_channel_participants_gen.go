...
// TypeInfo implements tdp.Object for ChannelsChannelParticipantsBox.
func (b *ChannelsChannelParticipantsBox) TypeInfo() tdp.Type {
	return b.ChannelParticipants.TypeInfo()
}
