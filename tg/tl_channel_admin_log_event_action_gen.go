...
// TypeInfo implements tdp.Object for ChannelAdminLogEventActionBox.
func (b *ChannelAdminLogEventActionBox) TypeInfo() tdp.Type {
	return b.ChannelAdminLogEventAction.TypeInfo()
}
